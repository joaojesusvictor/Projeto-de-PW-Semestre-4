...
<body>
    ...
    <h1 style="padding-left: 5%; padding-top: 5%; text-align: center; color: rgba(11, 94, 215);" >Buscando por
        Produto...</h1>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" style="padding-bottom: 25px;">
                <div class="card">
                    <img class="card-img-top" src="../Projeto-de-PW-Semestre-4/img/example3.png" alt="Card image">
                    <div class="card-body">
                        <h4 class="card-title">Samsumg Galaxy S20</h4>
                        <p class="card-text">R$2.000,00</p>
                        <a href="../Projeto-de-PW-Semestre-4/Details.php" class="btn btn-primary">Comprar</a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" style="padding-bottom: 25px;">
                <div class="card">
                    <img class="card-img-top" src="../Projeto-de-PW-Semestre-4/img/example4.png" alt="Card image">
                    <div class="card-body">
                        <h4 class="card-title">Samsumg Galaxy S20</h4>
                        <p class="card-text">R$2.000,00</p>
                        <a href="../Projeto-de-PW-Semestre-4/Details.php" class="btn btn-primary">Comprar</a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" style="padding-bottom: 25px;">
                <div class="card">
                    <img class="card-img-top" src="../Projeto-de-PW-Semestre-4/img/example5.png" alt="Card image">
                    <div class="card-body">
                        <h4 class="card-title">Samsumg Galaxy S20</h4>
                        <p class="card-text">R$2.000,00</p>
                        <a href="../Projeto-de-PW-Semestre-4/Details.php" class="btn btn-primary">Comprar</a>
